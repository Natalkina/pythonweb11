...
class Auth:
    ...
    def verify_password(self, plain_password, hashed_password):
        ...
        :param hashed_password: Compare the hashed password in the database with the hashed password that is generated from a plain text password
    ...
    async def create_refresh_token(self, data: dict, expires_delta: Optional[float] = None):
        ...
        :param self: Represent the instance of the class
        :param data: dict: Pass the user's information to the function
